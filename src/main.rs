...
use primitive::{Scene, Sphere, Triangle};
...
fn main() {
    ...
    let scene = Triangle::new(point(-1.0, 0.0, -3.0), point(1.0, 0.0, -1.0), point(0.0, 1.0, -3.0));
...
const LIGHT: DVec4 = point(-1.0, -1.0, 0.0);
const LIGHT_POWER: f64 = 200.0;
